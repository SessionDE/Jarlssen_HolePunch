...
class Jarlssen_HolePunch_Model_Container_Cache_Price_Configurable extends Enterprise_PageCache_Model_Container_Abstract {
    ...
    {
        return 'JARLSSEN_CACHE_PRICE_CONFIG'
