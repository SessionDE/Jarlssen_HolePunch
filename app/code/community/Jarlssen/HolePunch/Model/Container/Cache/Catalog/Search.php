...
class Jarlssen_HolePunch_Model_Container_Cache_Catalog_Search extends Enterprise_PageCache_Model_Container_Abstract {
    ...
    {
        return 'JARLSSEN_CACHE_CATALOG_SEARCH'
