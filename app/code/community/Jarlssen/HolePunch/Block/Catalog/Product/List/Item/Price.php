...
class Jarlssen_HolePunch_Block_Catalog_Product_List_Item_Price extends Mage_Catalog_Block_Product_Abstract
{
   ...
   protected $_template = 'catalog/product/list/item/price.phtml';
     ...
     */
    protected $_defaultItemPriceCacheKey = 'JARLSSEN_CACHE_CATALOG_PRODUCT_LIST_ITEM_PRICE';
